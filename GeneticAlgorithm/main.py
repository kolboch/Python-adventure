...
maxes, averages, mins = np.amax(generations_scores, axis=1), np.mean(generations_scores, axis=1), np.amin(
    generations_scores,
    axis=1)
...
avg_line, = plt.plot(averages, label="Mean", linewidth=2)
